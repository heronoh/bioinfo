...
rmd <- c(Sys.glob("~/prjcts/bioinfo/aulas/aulas_R/*.Rmd"),Sys.glob("~/prjcts/bioinfo/aulas/aulas_R/*.qmd"))
# rmd <- Sys.glob("*.Rmd")
rmd <- rmd[rmd != "index.Rmd"]
html <- sub(".Rmd|.qmd", ".html", rmd)
...
rmd <- Sys.glob("~/prjcts/bioinfo/aulas/aulas_bash/*.Rmd")
# rmd <- Sys.glob("*.Rmd")
rmd <- rmd[rmd != "index.Rmd"]
