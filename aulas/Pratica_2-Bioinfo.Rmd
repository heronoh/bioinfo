...
* **1&deg; grupo:** Permissões do _grupo_.

* **1&deg; grupo:** Permissões dos demais usuários.
...
&nbsp;&nbsp;&nbsp;&nbsp;
**DICA:** dentro do ***script***, o comando **echo "_sequência_"** deve ser substituído por **echo _$1_**. 
