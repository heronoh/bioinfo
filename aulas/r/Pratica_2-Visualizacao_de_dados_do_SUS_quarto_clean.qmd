---
title: Prática 2 — Visualização de dados do SUS
lang: pt-BR
date: last-modified
format:
  html:
...
::: {.callout-tip}
**Nota:** Este material foi reescrito para Quarto com foco em praticidade e reuso. 
Execute com `quarto render` ou no RStudio (Render).
:::
