...
description: "Utilizando o R para obter dados do SUS e realizar análises exploratórias utilizando visualização de dados"
execute:
  echo: true
  warning: false
  message: false
...
dados_SUS <-  read.csv(file = "~/prjcts/bioinfo/aulas/r/arquivos/dados_SUS_pneumo.csv",
                       sep = ",") %>% tibble::tibble()
```
...
Para facilitar, iremos trabalhar com um subconjunto já organizado, que deve ser baixado com o comando a seguir. Você irá fazer download do arquivo e em seguida iremos carregar esse arquivo para o R. 
...
download.file(
  "https://raw.githubusercontent.com/heronoh/bioinfo/main/aulas/r/arquivos/dados_SUS_pneumo.csv",
  destfile = "dados_SUS_pneumo.csv",
  mode = "wb",
  method = "libcurl"
  )
