...
![](/misc/IgorHAN.jpg){.mt-4 alt="Foto de perfil de Heron O. Hilário" style="border-radius:50%;object-fit:cover;display:block;margin-left:auto;margin-right:auto;"}
:::
:::
:::
...
rios <- st_read("/home/igorhan/projetos/aula_heron/shapes/ide_0104_mg_hidrografia_principal_lin.shp")
...
# recortar rios apenas para a bacia
rios_inter <- st_intersection(rios_wgs, bacia_wgs)
